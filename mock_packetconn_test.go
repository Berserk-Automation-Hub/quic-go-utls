...
//
//	mockgen -typed -package quic -self_package github.com/Berserk-Automation-Hub/quic-go-utls -self_package github.com/Berserk-Automation-Hub/quic-go-utls -destination mock_packetconn_test.go net PacketConn
//
